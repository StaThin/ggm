...
#' \code{\link{conComp}}, \code{\link{fundCycles}}; \item Functions for testing
#' independence statements and generating maximal graphs from non-maximal
#' graphs: \code{\link{dSep}}, \code{\link{msep}}, \code{\link{Max}}; \item
#' Function for finding covariance and concentration graphs induced by
#' marginalization and conditioning: \code{\link{inducedCovGraph}},
#' \code{\link{inducedConGraph}}; \item Functions for finding multivariate
#' regression graphs and chain graphs induced by marginalization and
#' conditioning: \code{\link{inducedRegGraph}},
...
#' @section Authors: Giovanni M. Marchetti, Dipartimento di Statistica,
#' Informatica, Applicazioni 'G. Parenti'. University of Florence, Italy
#' 
...
#' @section Acknowledgements: Many thanks to Fulvia Pennoni for testing some of
#' the functions, to Elena Stanghellini for discussion and examples and to
#' Claus Dethlefsen and Jens Henrik Badsberg for suggestions and corrections.
#' The function \code{fitConGraph} was corrected by Ilaria Carobbi. Helpful
#' discussions with Steffen Lauritzen and Nanny Wermuth, are gratefully
#' acknowledged. Thanks also to Michael Perlman, Thomas Richardson and David
#' Edwards.
#' 
#' Giovanni Marchetti has been supported by MIUR, Italy, under grant scheme
#' PRIN 2002, and Mathias Drton has been supported by NSF grant DMS-9972008 and
#' University of Washington RRF grant 65-3010.
...
#' dependencies}. London: Chapman & Hall.
#' 
#' Wermuth, N. & Cox, D.R. (2004). Joint response graphs and separation induced
#' by triangular systems. \emph{J.R. Statist. Soc. B}, 66, Part 3, 687-717.
